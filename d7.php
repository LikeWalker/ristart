...
<body>
			...
			<div class="wrapper__profile">
				...
				<div class="profile__wrapper__img">
					<div class="profile__img">
						<img class="impd__img__change" src="img/d7.png">
						<h1 class="impd__info">Эдуард хочет встать</h1>
						<div class="impd_info__goal">
							<p class="profile__info__human__text2">Помогаем купить устройство, чтобы мальчик смог стоять на ногах</p>
						</div>
						<div class="impd_info__goal">
							<p class="impd__info__text1">66 630 руб.  &ensp;</p>
							<p class="impd__info__text2">из 250 000 руб. </p>
						</div>
					...
					<div class="profile__text__info__0">
						<div class="profile__text__info">
							...
							<p class="impd__text__description">
								«У вашего ребенка ДЦП», – услышала мама вскоре после рождения сына. «Когда я впервые его увидела, подумала, что руки у меня опустились навсегда, – вспоминает она. – Что делать, куда бежать? Но потом я поняла, что никто кроме меня не сможет помочь моему мальчику. И мы начали бороться».
							</p>
						</div>
						<div class="profile__text__info">
							<p class="profile__text__all">
							...
							<h1 class="impd__text__report">
									 Врачи предсказывают скорейшие хождение Эдуарда. Уменьшили лечение так как ему стало лучше
							</h1>
						</div>
					</div>
				</div>
	...
	<script type="text/javascript">
		...
		let impd_count = 66630;
		let impd_goal = 250000;
