			...
			<div class="wrapper__profile">
				...
				<div class="profile__wrapper__img">
					<div class="profile__img">
						<img class="impd__img__change" src="img/d9.png">
						<h1 class="impd__info">Да, Тёмный Властелин!</h1>
						<div class="impd_info__goal">
							<p class="profile__info__human__text2">Настольная игра Темный Властелин от молодых талантов</p>
						</div>
						<div class="impd_info__goal">
					...
					<div class="profile__text__info__0">
						<div class="profile__text__info">
							...
							<p class="impd__text__description">
								«Да, Тёмный Властелин» — одна из тех редких настолок, в которых необходимо отыгрывать роль. При этом она гораздо легче «Ужаса Аркхэма», Descent и других атмосферных настольных игр.
						...
						<div class="profile__text__info">
							...
							<h1 class="impd__text__report">
									Игра Темный Властелин был одобрен на выход на полки магазинов!
							</h1>
						</div>
					</div>
				</div>
