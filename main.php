...
<body>
			...
			<div class="header__wrapper">
				...
				<nav class="header__nav">
					<ul class="header__list">
						...
						<li class="header__item">
							<a href="" class="header__link impd1">Все проекты</a>
						</li>
						<li class="header__item">
	...
	<script type="text/javascript">
		let impd = document.querySelector('.impd1');
		...
		impd.onclick = function(){
			alert('Извините, но для использования данного раздела, нужно войти в учетную запись' );
		}
		impd2.onclick = function(){
			alert('Извините, но для использования данного раздела, нужно войти в учетную запись' );
		}
		impd3.onclick = function(){
			alert('Извините, но для использования данного раздела, нужно войти в учетную запись' );
		}
		impd4.onclick = function(){
			alert('Извините, но для использования данного раздела, нужно войти в учетную запись' );
		}
		impd5.onclick = function(){
			alert('Извините, но для использования данного раздела, нужно войти в учетную запись' );
		}
		d1.onclick = function(){
			alert('Извините, но для использования данного раздела, нужно войти в учетную запись' );
