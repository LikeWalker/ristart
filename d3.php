			...
			<div class="wrapper__profile">
				...
				<div class="profile__wrapper__img">
					<div class="profile__img">
						<img class="impd__img__change" src="img/d3.png">
						<h1 class="impd__info">Доставка продуктов</h1>
						<div class="impd_info__goal">
							<p class="profile__info__human__text2">Создание местной доставки продуктов в г. Якутск</p>
						</div>
						<div class="impd_info__goal">
							<p class="impd__info__text1">23 620 руб. &ensp;</p>
							<p class="impd__info__text2">из 80 000 руб.</p>
						</div>
					...
					<div class="profile__text__info__0">
						<div class="profile__text__info">
							...
							<p class="impd__text__description">
								Доставка продуктов на дом все больше пользуется спросом у россиян. Ежегодно этот рынок растет минимум на 50%. Однако несмотря на востребованность услуги, многие не представляют, как устроена доставка товаров повседневного спроса.
							</p>
						</div>
						<div class="profile__text__info">
							<p class="profile__text__all">
							...
							<h1 class="impd__text__report">
									 Осталось совсем чуть чуть до выхода нашего собственного приложения. 
							</h1>
						</div>
					</div>
				</div>
