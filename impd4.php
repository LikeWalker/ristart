			...
			<div class="wrapper__profile">
				...
				<div class="profile__wrapper__img">
					<div class="profile__img">
						<img class="impd__img__change" src="img/impd4.png">
						<h1 class="impd__info">Фонд «Чистые моря»</h1>
						<div class="impd_info__goal">
							<p class="profile__info__human__text2">Помогаем в очистке моря от мусора.</p>
						</div>
						<div class="impd_info__goal">
					...
					<div class="profile__text__info__0">
						<div class="profile__text__info">
							...
							<p class="impd__text__description">
									Повышенное внимание к решению проблем экологической безопасности и ответственности — один из основных принципов динамично развивающегося государства. Фонд «Чистые моря» призывает объединиться ученых, политиков и бизнесменов для адекватного взаимодействия в борьбе за сохранение водной среды и биоразнообразие ее живых ресурсов.
							</p>
						</div>
						<div class="profile__text__info">
							<p class="profile__text__all">
							...
							<h1 class="impd__text__report">
									На показе фильма «Рядом с медведями. Дневник воздушной экспедиции -2» свободных мест в зале не оказалось. Все пришли 
							</h1>
						</div>
					</div>
				</div>
