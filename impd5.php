...
<body>
			...
			<div class="wrapper__profile">
				...
				<div class="profile__wrapper__img">
					<div class="profile__img">
						<img class="impd__img__change" src="img/impd5.png">
						<h1 class="impd__info">Алкоголизм</h1>
						<div class="impd_info__goal">
							<p class="profile__info__human__text2">Алкоголик в семье - беда. Страдает семья.</p>
						</div>
						<div class="impd_info__goal">
							<p class="impd__info__text1">26 518 руб.&ensp;</p>
							<p class="impd__info__text2">из 400 000 руб.</p>
						</div>
					...
					<div class="profile__text__info__0">
						<div class="profile__text__info">
							...
							<p class="impd__text__description">
									Самое страшное, что сам алкоголик часто не задумывается о своем состоянии. Он доказывает, что может бросить пить в любой момент, и категорически не признает себя алкоголиком.
							</p>
						</div>
						<div class="profile__text__info">
							<p class="profile__text__all">
							...
							<h1 class="impd__text__report">
									 Начали задумывать места для проведения консультаций для людей страдающих алкогольной зависимостью.
							</h1>
						</div>
					</div>
				</div>
	...
	<script type="text/javascript">
		...
		let impd_count = 26518;
		let impd_goal = 400000;
